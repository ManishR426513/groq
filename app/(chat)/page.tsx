...
export default function Page() {
  // Your Groq API Key
  const GROQ_API_KEY =
    "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";
...
Error details: ${error.message}`;
  ...
  const addKnowledge = () => {
    ...
    setAgents((prev) =>
      prev.map((a) => (a.id === currentAgent.id ? updatedAgent : a))
    );
  ...
  return (
    <div className="flex h-screen bg-white dark:bg-gray-950">
      ...
      <div
        ...
        } fixed inset-y-0 left-0 z-50 w-72 bg-white dark:bg-gray-950 border-r border-gray-200 dark:border-gray-800 transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0`}
      >
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                          {chat.mode === "agentic" ? "🤖 Agent" : "🌍 Global"} •{" "}
            ...
            {chatMode === "agentic" && (
              <>
                <select
                  ...
                  onChange={(e) =>
                    setCurrentAgent(
                      agents.find((a) => a.id === e.target.value) || null
                    )
                  }
                >
              ...
              <div className="mx-auto max-w-2xl px-4">
                {messages.length === 0 ? (
                        ...
                        {suggestions.map((suggestion, index) => (
                          ...
                          >
                            ...
                            <div className="font-medium text-gray-900 dark:text-gray-100">
                              {suggestion.text.split(" ").slice(0, 6).join(" ")}
                            </div>
                            <div className="text-gray-600 dark:text-gray-400 text-xs">
                              {suggestion.text.split(" ").slice(6).join(" ")}
                            </div>
                          </button>
                        ))}
                      </div>
                  ...
                  messages.map((message, index) => (
                    ...
                    >
                      <div
                        className={`flex size-8 shrink-0 select-none items-center justify-center rounded-md border shadow ${
                          message.role === "user"
                      ...
                      <div className="flex-1 px-1 ml-4 space-y-2 overflow-hidden">
                        <div className="prose break-words dark:prose-invert prose-p:leading-relaxed prose-pre:p-0">
                          <p className="mb-2 last:mb-0 whitespace-pre-wrap text-gray-900 dark:text-gray-100">
                            {message.content}
                          </p>
                        </div>
                ...
                <div className="relative flex max-h-60 w-full grow flex-col overflow-hidden bg-white dark:bg-gray-950 px-8 sm:rounded-md sm:border sm:border-gray-200 dark:sm:border-gray-700 sm:px-12">
                  ...
                  <div className="absolute left-0 top-4 size-8 rounded-full bg-white dark:bg-gray-950 p-0 sm:left-4">
                    ...
                    >
                      ...
                      >
                        <path
                          d="M7.5 1C7.77614 1 8 1.22386 8 1.5V7H14.5C14.7761 7 15 7.22386 15 7.5C15 7.77614 14.7761 8 14.5 8H8V14.5C8 14.7761 7.77614 15 7.5 15C7.22386 15 7 14.7761 7 14.5V8H0.5C0.223858 8 0 7.77614 0 7.5C0 7.22386 0.223858 7 0.5 7H7V1.5C7 1.22386 7.22386 1 7.5 1Z"
                          fill="currentColor"
                          fillRule="evenodd"
                          clipRule="evenodd"
                        ></path>
                  ...
                  <div className="absolute right-0 top-4 sm:right-4">
                    ...
                    >
                      ...
                      >
                        <path
                          d="m221.24 136.88-96-32a8 8 0 0 0-10.5 10.5l32 96a8 8 0 0 0 15.18 1.1l13.89-41.67 41.67-13.89a8 8 0 0 0-1.1-15.18Z"
                          opacity="0.2"
                        ></path>
            ...
            <div className="fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-950 p-6 shadow-lg duration-200 sm:rounded-lg">
              <div className="flex flex-col space-y-1.5 text-center sm:text-left">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Create a specialized AI agent with custom knowledge.
                </p>
              </div>
        ...
        {showTrainer && currentAgent && (
          <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm">
            <div className="fixed left-[50%] top-[50%] z-50 grid w-full max-w-2xl translate-x-[-50%] translate-y-[-50%] gap-4 border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-950 p-6 shadow-lg duration-200 sm:rounded-lg max-h-[80vh] overflow-y-auto">
              <div className="flex flex-col space-y-1.5 text-center sm:text-left">
                <h2 className="text-lg font-semibold leading-none tracking-tight text-gray-900 dark:text-gray-100">
                  Train {currentAgent.name}
                </h2>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Add knowledge to help your agent answer questions accurately.
                </p>
              </div>
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <h3 className="font-medium text-gray-900 dark:text-gray-100">
                      Knowledge Base ({currentAgent.knowledgeBase.length} items)
                    </h3>
                    <button
                      onClick={() => {
                        if (
                          confirm(
                            "Are you sure you want to clear all knowledge for this agent?"
                          )
                        ) {
                          const updatedAgent = {
                            ...currentAgent,
                  ...
                  <div className="rounded-md border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 p-3 max-h-32 overflow-y-auto">
                    {currentAgent.knowledgeBase.map((kb, index) => (
                      <div
                        key={index}
                        className="text-sm mb-2 p-2 bg-white dark:bg-gray-950 rounded text-gray-900 dark:text-gray-100"
                      >
                        <strong>#{index + 1}:</strong> {kb.substring(0, 150)}
                        {kb.length > 150 ? "..." : ""}
                      </div>
                    ))}
                  </div>
